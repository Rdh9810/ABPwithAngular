...
using Abp.UI;
using WebWithAngular.Authentication.External;
using WebWithAngular.Authentication.JwtBearer;
...
namespace WebWithAngular.Controllers
{
    ...
    public class TokenAuthController : WebWithAngularControllerBase
    {
