...
namespace WebWithAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly WebWithAngularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = WebWithAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WebWithAngularDbContext context)
        {
            _context = context;
        }
