...
{
    public abstract class WebWithAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WebWithAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WebWithAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WebWithAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WebWithAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WebWithAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WebWithAngularDbContext, Task<T>> func)
        {
            T result;
